  ...
  return (
    <div className="space-y-10">
      <div className="space-y-2">
        <h1 className="text-4xl font-extrabold tracking-tight">עגלת קניות</h1>
        <p className="text-lg text-muted-foreground">
          כאן תוכלו לצפות במוצרים שהוספתם לעגלה ולבצע רכישה.
        </p>
      </div>
                    ...
                    <div className="rounded-xl border border-border bg-muted/30 p-6">
                      ...
                      <ul className="mt-4 space-y-3 text-sm text-muted-foreground">
                        <li className="flex gap-2">
                          ...
                          <span><strong>משלוח חינם</strong> לכל חלקי הארץ ברכישה מעל ₪199.</span>
                        </li>
                        <li className="flex gap-2">
                          <span className="size-1.5 shrink-0 rounded-full bg-primary mt-1.5" />
