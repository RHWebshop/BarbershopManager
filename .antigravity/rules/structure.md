---
description: Barbershop Manager monorepo structure and boundaries
globs: ["**/*"]
alwaysApply: true
---

# Barbershop Manager monorepo rules
...
### apps/barbershop-manager-admin (React + Vite)
...
- Shared schemas/types duplicated locally (use `packages/barbershop-manager-schemas` and `packages/barbershop-manager-types`).

### apps/barbershop-manager-client (React + Vite)
...
### apps/barbershop-manager-api (Nest.js)
...
### packages/barbershop-manager-types
...
### packages/barbershop-manager-schemas
...
- May depend on `barbershop-manager-types`.
- Must not include fetching, DB access, Nest wiring, or UI components.

### packages/barbershop-manager-utils
...
- `apps/barbershop-manager-admin` must not import from `apps/barbershop-manager-client` (and vice versa).
- `packages/*` must not import from `apps/*`.
- Do not use deep imports into package internals. Import only from the package entry:
  - ✅ `import { X } from "@barbershop-manager/utils"`
  - ❌ `import { X } from "@barbershop-manager/utils/src/..."`
