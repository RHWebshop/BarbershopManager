  ...
  return (
    <div className="space-y-10">
      <div className="space-y-2">
        <h1 className="text-4xl font-extrabold tracking-tight">דף הבית (לקוח)</h1>
        <p className="text-lg text-muted-foreground">
          בדף הבית ניתן לראות את התור הנוכחי שעתיד להתקיים + מוצרים נבחרים
        </p>
      </div>
              ...
              <div className="flex items-center gap-5 rounded-2xl border border-border bg-card p-6 shadow-sm">
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-1 flex items-center gap-2 text-muted-foreground">
                    ...
                    <span>{formatDate(nextLine.date)} · {nextLine.time}</span>
                  </div>
                </div>
