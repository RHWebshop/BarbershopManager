import type { Product } from "@barbershop-manager/types";
...
export const PRODUCTS: Product[] = [
	...
	},
	{
		...
		description: "צביעה מלאה בצבעים איכותיים ועמידים. כוללת ייעוץ צבע, ביצוע הצביעה, שטיפה וטיפול לאחר צביעה.",
		price: 350,
		category: "color",
	...
	},
	{
		id: "4",
		name: "גוונים / הייליטס",
		description: "הבהרה חלקית או גוונים עדינים ליצירת מראה טבעי ורענן. מתאים למי שרוצה שינוי עדין עם אפקט מרשים.",
		price: 400,
		category: "color",
...

	{
		...
		description: "טיפול עומק לשיקום שיער פגום ויבש. משתמשים בחומרים מקצועיים שמחזירים לשיער לחות, ברק וחיוניות.",
		price: 200,
		category: "treatment",
	...
	},
	{
		id: "8",
		name: "שמפו מקצועי",
		description: "שמפו איכותי לשימוש יומיומי. מנקה בעדינות, שומר על לחות טבעית ומתאים לכל סוגי השיער.",
		price: 75,
		category: "product",
	...
	},
	{
		...
		description: "מסכה עשירה בויטמינים ושמנים טבעיים. מעניקה הזנה עמוקה ומשאירה את השיער רך ומבריק.",
		price: 95,
		category: "product",
		isFeatured: true,
	...
	},
	{
		id: "10",
		name: "ספריי עיצוב",
		description: "ספריי עיצוב קל לאחיזה גמישה. מאפשר עיצוב טבעי ללא קשיחות, מתאים לשימוש יומיומי.",
		price: 65,
		category: "product",
