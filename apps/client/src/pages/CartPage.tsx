...
import { useCartStore, selectTotalCount, selectTotalPrice } from "@/stores/carStore";
			...
			<div className="flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
				<div className="space-y-2">
					...
					<p className="text-lg text-muted-foreground">
						יש לך {totalCount} פריטים בסל הקניות
					</p>
				</div>
				<Button
					variant="ghost"
							...
							<div className="mt-6 space-y-4">
								<div className="flex justify-between text-sm">
									<span className="text-muted-foreground">
										סיכום ביניים ({totalCount} פריטים)
									</span>
						...
						<div className="rounded-xl border border-border bg-muted/30 p-6">
							...
							<ul className="mt-4 space-y-3 text-sm text-muted-foreground">
								<li className="flex gap-2">
									...
									<span>
										<strong>משלוח חינם</strong> לכל חלקי הארץ ברכישה
										מעל ₪199.
									</span>
								</li>
								<li className="flex gap-2">
								...
								<li className="flex gap-2">
									<span className="size-1.5 shrink-0 rounded-full bg-primary mt-1.5" />
									<span>
										ניתן להחזיר מוצרים תוך 14 יום באריזתם המקורית.
									</span>
								</li>
							</ul>
						</div>
